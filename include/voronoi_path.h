...
namespace voronoi_path
{
    ...
    private:
        ...
        /**
         * Hashing function which takes 2 doubles, upto hash_resolution decimal places, and the concatenates them into a string
         * Each double can have upto hash_length digits
